...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "What Engine (Beta) [Psych version " + psychEngineVersion+"]", 12);
		...
		super.create();
		startHScript("states/MainMenuAddons.hx");
	}
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			{
				acceptPressed();
				quickCallHscript("acceptPressed",[]);
