...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		for (i in 0...8){
			var note:StrumNote = new StrumNote(GRID_SIZE * (i+1), strumLine.y, i % 4, 0, (i >= 4)?1:0);
	...
	function addSongUI():Void
	{
		...
		oppSkinInputText = new FlxUIInputText(player2DropDown.x + 160, player2DropDown.y + 50, 120, skin2, 8);
